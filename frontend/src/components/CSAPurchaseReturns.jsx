...
function CSAPurchaseReturns() {
  ...
  const fetchPurchaseReturns = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/csa/distributors/${distId}/purchase-returns`, { headers: getAuthHeaders() })
      if (res.ok) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const distId = selectedDistributor.distributorId || selectedDistributor.id
      const res = await fetch(`${API_URL}/csa/distributors/${distId}/purchase-returns/create`, {
        method: 'POST',
        headers: { 
      ...
      {showList ? (
        ...
        <div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 mb-6">
            <div className="relative mb-4" ref={distributorDropdownRef}>
              ...
              <div
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 cursor-pointer flex items-center justify-between"
              >
          ...
          {/* Add Product */}
          {selectedDistributor && !savedReturn && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 mb-6">
...
export default CSAPurchaseReturns