...
function CSASalesReturns() {
  ...
  const fetchSalesReturns = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/csa/distributors/${distId}/sales-returns`, { headers: getAuthHeaders() })
      if (res.ok) {
  ...
  const handleSave = async (shouldPrint = false) => {
    ...
    try {
      ...
      const distId = selectedDistributor.distributorId || selectedDistributor.id
      const res = await fetch(`${API_URL}/csa/distributors/${distId}/sales-returns/create`, {
        method: 'POST',
        headers: { 
...
export default CSASalesReturns
